...
```python
import nefile
from nefile.resources import ResourceType
...
print(progman.resource_table.resource_types.keys())
...
print(progman.resource_table.resource_types[ResourceType.RT_GROUP_ICON])
